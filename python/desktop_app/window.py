...
class DashboardPage(QWidget):
    ...
    def _refresh_metrics(self, *, force_processes: bool = False, force_disk: bool = False) -> None:
        self._tick_count += 1
        include_processes = force_processes or self._sample is None or self._tick_count % 3 == 0
        include_disk = force_disk or self._sample is None or self._tick_count % 8 == 0
        try:
